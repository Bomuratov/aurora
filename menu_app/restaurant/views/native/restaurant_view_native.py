...
from menu_app.restaurant.views.docs.restaurant_view_docs import native_docs
...
@extend_schema_view(
    list=extend_schema(tags=native_docs.tags, description=native_docs.description.get_list),
    retrieve=extend_schema(tags=native_docs.tags, description=native_docs.description.get_retrieve),
    create=extend_schema(tags=native_docs.tags, description=native_docs.description.create),
    update=extend_schema(tags=native_docs.tags, description=native_docs.description.update),
    partial_update=extend_schema(
        tags=native_docs.tags, description=native_docs.description.partial_update
    ),
    destroy=extend_schema(tags=native_docs.tags, description=native_docs.description.destroy),
)
...
@extend_schema_view(
    list=extend_schema(tags=native_docs.tags, description=native_docs.description.get_channel_pm),
    retrieve=extend_schema(tags=native_docs.tags, description=native_docs.description.get_channel),
)
...
@extend_schema_view(
    retrieve=extend_schema(tags=native_docs.tags, description=native_docs.description.get_editors),
)
